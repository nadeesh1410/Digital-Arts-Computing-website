...
const NAV_LIST = [
    ...
    { text: "uncertain (unfolding)", href: "/uncertain" },
    { text: "Posters", href: "/images/2026artworks/WIP_PosterFront.png" },
    { text: "Floorplan", href: "/images/2026artworks/WIP_POsterBack.png" },
